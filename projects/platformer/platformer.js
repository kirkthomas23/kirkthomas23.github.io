$(function () {
  ...
  function setup() {
    ...
    createCollectable("steve", 100, 290,0.5,0.5);

    createCollectable("max", 200, 590,0.5,0.5);

    createCollectable("database", 300, 490,0.5,0.5);

    createCollectable("grace", 800, 190,0.5,0.5);

    createCollectable("kennedi", 400, 190,0.5,0.5);
